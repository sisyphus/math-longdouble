...
if($Math::LongDouble::VERSION eq '0.27' && Math::LongDouble::_get_xs_version() eq $Math::LongDouble::VERSION) {print "ok 1\n"}
...
if(Math::LongDouble::_use_powq()) {
  warn "USE_POWQ is defined\n";
}
else {
